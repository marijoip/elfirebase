package com.example.elfirebase;
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (password.length() < 6) {
                    Toast.makeText(getApplicationContext(), "Contraseñ demasiado corta, ingrese un mínimo de 6 caracteres!", Toast.LENGTH_SHORT).show();
                    return;
                }
